...
--
-- Host: localhost
-- Generation Time: Mar 06, 2015 at 05:06 AM
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `linkCount` int(5) NOT NULL DEFAULT '0',
...
INSERT INTO `product` (`product_id`, `title`, `link`, `image`, `manufacturer_id`, `date_available`, `sort_order`, `status`, `viewCount`, `linkCount`, `favoriteCount`, `duration`, `date_added`, `date_modified`, `user_id`, `customer_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `url_alias` (
  ...
  KEY `query` (`query`),
  KEY `keyword` (`keyword`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=855 ;
