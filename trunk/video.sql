...
--
-- Host: localhost
-- Generation Time: Mar 04, 2015 at 03:54 PM
...
INSERT INTO `product` (`product_id`, `link`, `image`, `manufacturer_id`, `date_available`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`, `user_id`, `customer_id`, `loved`, `duration`) VALUES
...
(42, '', 'catalog/demo/apple_cinema_30.jpg', 8, '2009-02-04', 0, 1, 1, '2009-02-03 21:07:37', '2015-02-24 14:20:14', NULL, NULL, 0, ''),
...
CREATE TABLE IF NOT EXISTS `url_alias` (
  ...
  KEY `query` (`query`),
  KEY `keyword` (`keyword`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=850 ;
